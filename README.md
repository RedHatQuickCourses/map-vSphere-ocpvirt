# Red Hat OpenShift Virtualization: Map vSphere features to OpenShift Virtualization
...
This course focus on identifying and mapping of features and capabilities of Red Hat OpenShift Virtualization that are equivalent to VMware vSphere's one.
...
```
    $ git clone git@github.com:RedHatQuickCourses/map-vSphere-ocpvirt.git
```

2. Install the npm dependencies for the course tooling.
```
    $ cd map-vSphere-ocpvirt
    $ npm install
```
...
12. Verify that your changes have been published to the production GitHub pages website at https://redhatquickcourses.github.io/map-vSphere-ocpvirt

## Problems and Feedback
If you run into any issues, report bugs/suggestions/improvements about this course here - https://github.com/RedHatQuickCourses/map-vSphere-ocpvirt/issues
